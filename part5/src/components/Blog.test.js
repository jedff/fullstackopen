...
test('render blog title and author only', () => {
  ...
  const { container } = render(<Blog blog={blog} user={user} removeBlog={mockRemoveBlogHandler} likeBlog={mockLikeBlogHandler} />)
...
test('like button is cliked twice', async () => {
  ...
  render(<Blog blog={blog} user={user} removeBlog={mockRemoveBlogHandler} likeBlog={mockLikeBlogHandler} />)
